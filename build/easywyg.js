...
var _grid = require('../views/grid.es6');
...
var _image = require('../views/image.es6');
...
var _paragraph = require('../views/paragraph.es6');
...
var _class = function (_Entity) {
  ...
  function _class() {
    ...
    _this.view = new _paragraph2.default();
    return _this;
  }
...
var _class = function () {
  ...
  _createClass(_class, [{
    ...
    value: function vnode() {
      ...
      return new (Function.prototype.bind.apply(_virtualDom.VNode, [null].concat(args)))();
    }
  }, {
    key: 'vtext',
    value: function vtext() {
...
var _class = function (_View) {
  ...
  _createClass(_class, [{
    key: 'build',
    value: function build(entity) {
      var img = this.vnode('img', { attributes: entity.attrs.img });

      if (entity.attrs.a.href) {
        img = this.vnode('a', { attributes: entity.attrs.a }, [img]);
      }

      var caption = this.vnode('figcaption', { attributes: entity.attrs.figcaption }, [this.vtext(entity.caption)]);
...
var _class = function (_View) {
  ...
  _createClass(_class, [{
    key: 'build',
    value: function build(entity) {
      return this.vnode(entity.tag, {}, [this.vtext(entity.text)]);
    }
  }]);
